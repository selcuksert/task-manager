...
export function addUser(selectedUser, secObj) {
    return fetch(`http://user-writer-task-manager.apps-crc.testing/api/user/writer`, {
        method: 'post',
        body: JSON.stringify({
...
export function getUsers(secObj) {
    return fetch(`http://user-reader-task-manager.apps-crc.testing/api/user/reader`, {
        method: 'get',
        headers: {
            "Content-Type": "application/json",
            "Accept": "application/json",
